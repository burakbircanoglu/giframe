...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Activity activity, int cameraId, LayoutMode mode,int w,int h) {
        super(activity); // Always necessary
        previewRatio=(double) (w/h);
    ...
    protected boolean adjustSurfaceLayoutSize(Camera.Size previewSize, boolean portrait,int widht,int height){
   ...
   // public Size determinePictureSize(){
   // 	Size newSize=mPictureSizeList.get(mPictureSizeList.size()-1);
   // 	
   // 	double min=Math.abs((mPictureSizeList.get(0).width/mPictureSizeList.get(0).height)-previewRatio);
   // 	for (Size size : mPictureSizeList) {
   //		Double thisRatio=(double) (size.width/size.height);
//		if(Math.abs(thisRatio-previewRatio)<min){
//    		min=Math.abs(thisRatio-previewRatio);
 //   		newSize=size;
//			}	
//			
  //  	}
  ...
  //  }
   ...
   // public Size determinePreviewSize(){
    //	Size newSize=mPreviewSizeList.get(mPreviewSizeList.size()-1);
    //	
    //	double min=Math.abs((mPreviewSizeList.get(0).width/mPreviewSizeList.get(0).height)-previewRatio);
